...
- COST_OPTIMIZATION_CPU_PEAK_CAP_PERCENT (default: 50.0)
...
- COST_OPTIMIZATION_MIN_DATA_HOURS (default: 3.0)  
- COST_OPTIMIZATION_SKIP_CROSS_FAMILY_OPTIMIZATION (default: true)   
